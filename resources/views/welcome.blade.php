...
{{-- ZONA DE IMAGEN --}}
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                ...
                <div class="flex justify-center">
                    <h1 style="font-weight: bold; font-size: 1.5em">ALMACÉN CENTRAL VES</h1>
                </div>

<br>
                <div class="flex justify-center">
                    {{-- <a href="#"
                    style="color: blue;  font-weight: bold; font-size: 1em"
                    class="font-semibold text-gray-600 hover:text-gray-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">
                        Ir a Administrador
                    </a> --}}

                    {!! Form::open(['method' => 'GET', 'url' => 'admin', 'class' => 'form-horizontal']) !!}

                    <button type="submit" style="color: white; padding: 20px; background-color: rgb(60, 167, 209)">Ver administracion</button>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                        ...
                        <div class="scale-100 p-6 bg-white from-gray-700/50 via-transparent rounded-lg shadow-2xl shadow-gray-500/20 flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                            <div>
                                ...
                                <h2 class="mt-6 text-xl font-semibold text-gray-900">Roles </h2>

                                <p class="mt-4 text-gray-500 text-sm leading-relaxed">
                                    Para la seguridad del sistema, se implementó roles de usuario, los cuales comprende de administrador y usuario común, cualquier cambio de accesos o creacion de usuarios
                                    deben ser notificados al Area de UDT.
                ...
                <div class="flex justify-center mt-16 px-0 sm:items-center sm:justify-between">
                    ...
                    <div class="ml-4 text-center text-sm text-gray-500 sm:text-right sm:ml-0">
                        Laravel v{{ Illuminate\Foundation\Application::VERSION }} (PHP v{{ PHP_VERSION }}) -   UDT : desarrolloudt@munives.gob.pe
                    </div>
                </div>
            </div>
        </div>
